...
modeldir=Results/Finetune-$benchmark-$arch-$image_representation-$description-lr$lr-bs$batchsize$precision$classifier_factor
if [ ! -d  "Results" ]; then
